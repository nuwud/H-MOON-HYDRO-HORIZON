...
final class Plugin {
    ...
    private function load_autoloader(): void {
        ...
        if ( file_exists( $autoloader ) ) {
            ...
            // Fallback PSR-4 autoloader for development
    ...
    public function plugin_action_links( array $links ): array {
        $plugin_links = [
            '<a href="' . admin_url( 'admin.php?page=woo-ach-batch-settings' ) . '">' . __( 'Settings', 'woo-ach-batch' ) . '</a>',
            '<a href="' . admin_url( 'admin.php?page=woo-ach-batch-batches' ) . '">' . __( 'Batches', 'woo-ach-batch' ) . '</a>',
        ];
