...
sftp = ssh.open_sftp()
sftp.put(os.path.join(BASE, "outputs", "seed_audit.php"),
         f"{SITE_DIR}/wp-content/seed_audit.php")
sftp.close()

stdin, stdout, stderr = ssh.exec_command(
    f"cd {SITE_DIR} && wp eval-file wp-content/seed_audit.php",
    timeout=120)
...
# Save
outpath = os.path.join(BASE, "outputs", "seed_audit_output.txt")
